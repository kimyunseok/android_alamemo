...
class FutureFragment: BaseTabFragment<TabFragmentBinding>() {
    ...
    override fun setTitle() {
        viewDataBinding.model?.title?.value = context?.getString(R.string.future_emoji) + " " + context?.getString(R.string.future_schedule)
    }
